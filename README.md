...
Android Clean Architecture in this sample project presents a modern, approach to [Android](https://www.android.com/) application development using [Kotlin](https://kotlinlang.org/) and the latest tech stack.
...
### BuildSrc Module
The ``buildSrc`` layer is responsible for dependency management. It controls and manages all dependencies in one place with Kotlin.  Check my story on [medium](https://medium.com/@dawinderapps/dependency-management-with-buildsrc-and-kotlin-dsl-f6826e2a2383) if you want to learn about this in detail.

### App Module
This module contains all the application relates classes, divided into different packages based on their responsibilities.
...
- [Compose Glide](https://bumptech.github.io/glide/int/compose.html) - An image loading library to load images, downsampling, and cache without any memory leak.
...
- [Gradle Kotlin DSL](https://gradle.org/kotlin/) - It makes it easy to manage dependency on all modules that we have.
